    ...
    >
      <Form id="checklistForm" className='bg-[#f3f5f5]'>
        ...
        <table>
          ...
          <tr>
            ...
            <td>Sound</td>
            <td><Field as="select" name="Crane_Control_Panel_Result">
            ...
            <td><Field as="select" name="Hoisting_Drive_Motor_sound_action" >
              <option value="" disabled selected>Select option</option>
          ...
          <tr>
            ...
            <td>Temperature</td>
            <td>Touch</td>
            <td><Field as="select" name="Hoisting_Drive_Motor_Temperature_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Hoisting_Drive_Motor_Temperature_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Lining gap</td>
            <td>Measure</td>
            <td><Field as="select" name="Hoisting_Drive_E_magnetic_brake_gap_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Hoisting_Drive_E_magnetic_brake_gap_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Visual</td>
            <td><Field as="select" name="Hoisting_Drive_E_magnetic_brake_wear_tear_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Hoisting_Drive_E_magnetic_brake_wear_tear_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Rotating sound</td>
            <td>Sound</td>
            <td><Field as="select" name="Hoisting_Drive_Cyclo_gear_sound_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Hoisting_Drive_Cyclo_gear_sound_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Visual</td>
            <td><Field as="select" name="Hoisting_Drive_Cyclo_gear_leakage_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Hoisting_Drive_Cyclo_gear_leakage_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Grease amount</td>
            <td>Visual</td>
            <td><Field as="select" name="Hoisting_Drive_Cyclo_gear_Grease_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Hoisting_Drive_Cyclo_gear_Grease_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Lubrication</td>
            <td>Visual</td>
            <td><Field as="select" name="Hoisting_Drive_wire_ropes_Lubrication_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Hoisting_Drive_wire_ropes_Lubrication_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Wear & tear</td>
            <td>Measure</td>
            <td><Field as="select" name="Hoisting_Drive_wire_ropes_Wear_tear_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Hoisting_Drive_wire_ropes_Wear_tear_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Wear & tear</td>
            <td>Visual</td>
            <td><Field as="select" name="Hoisting_Drive_Traction_sheaves_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Hoisting_Drive_Traction_sheaves_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Home position</td>
            <td>Visual</td>
            <td><Field as="select" name="Hoisting_Drive_sensing_plate_home_position_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Hoisting_Drive_sensing_plate_home_position_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Visual</td>
            <td><Field as="select" name="Hoisting_Drive_sensing_plate_Slowdown_position_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Hoisting_Drive_sensing_plate_Slowdown_position_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Visual</td>
            <td><Field as="select" name="Hoisting_Drive_sensing_plate_Over_run_limit_position_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Hoisting_Drive_sensing_plate_Over_run_limit_position_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Lower level</td>
            <td>Visual</td>
            <td><Field as="select" name="Hoisting_Drive_stop_position_Lower_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Hoisting_Drive_stop_position_Lower_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Upper level</td>
            <td>Visual</td>
            <td><Field as="select" name="Hoisting_Drive_stop_position_Upper_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Hoisting_Drive_stop_position_Upper_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Visual</td>
            <td><Field as="select" name="Hoisting_Drive_guide_rollers_Clearance_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Hoisting_Drive_ guide_rollers_Clearance_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Wear & tear</td>
            <td>Measure</td>
            <td><Field as="select" name="Hoisting_Drive_guide_rollers_Wear_tear_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Hoisting_Drive_guide_rollers_Wear_tear_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
        ...
        <table>
          ...
          <tr>
            ...
            <td>Rotating sound</td>
            <td>Sound</td>
            <td><Field as="select" name="Travel_Drive_Motor_sound_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_Motor_sound_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Temperature</td>
            <td>Touch</td>
            <td><Field as="select" name="Travel_Drive_Motor_Temperature_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_Motor_Temperature_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Lining gap</td>
            <td>Measure</td>
            <td><Field as="select" name="Travel_Drive_E_magnetic_brake_gap_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_E_magnetic_brake_gap_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Lining wear & tear</td>
            <td>Visual</td>
            <td><Field as="select" name="Travel_Drive_E_magnetic_brake_wear_tear_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_E_magnetic_brake_wear_tear_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Rotating sound</td>
            <td>Sound</td>
            <td><Field as="select" name="Travel_Drive_Cyclo_gear_sound_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_Cyclo_gear_sound_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Oil level / leakage</td>
            <td>Visual</td>
            <td><Field as="select" name="Travel_Drive_Cyclo_gear_leakage_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_Cyclo_gear_leakage_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Grease amount</td>
            <td>Visual</td>
            <td><Field as="select" name="Travel_Drive_Cyclo_gear_Grease_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            </Field></td>
            <td><Field as="select" name="Travel_Drive_Cyclo_gear_Grease_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Rotating sound</td>
            <td>Sound</td>
            <td><Field as="select" name="Travel_Drive_Front_wheel_sound_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_Front_wheel_sound_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Wear & tear</td>
            <td>Visual</td>
            <td><Field as="select" name="Travel_Drive_Front_wheel_Wear_tear_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_Front_wheel_Wear_tear_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td></td>
            <td>Measure</td>
            <td><Field as="select" name="Result" /></td>
            <td><Field as="select" name="Action" /></td>
          ...
          <tr>
            ...
            <td>Rotating sound</td>
            <td>Sound</td>
            <td><Field as="select" name="Travel_Drive_Rear_wheel_sound_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_Rear_wheel_sound_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Wear & tear</td>
            <td>Visual</td>
            <td><Field as="select" name="Travel_Drive_Rear_wheel_Wear_tear_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_Rear_wheel_Wear_tear_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td></td>
            <td>Measure</td>
            <td><Field as="select" name="Travel_Drive_Rear_wheel_Wear_tear_measure_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_Rear_wheel_Wear_tear_measure_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Wear & tear</td>
            <td>Measure</td>
            <td><Field as="select" name="Travel_Drive_top_guide_rollers_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_top_guide_rollers_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Wear & tear</td>
            <td>Measure</td>
            <td><Field as="select" name="Travel_Drive_Bottom_guide_rollers_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_Bottom_guide_rollers_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Home position</td>
            <td>Visual</td>
            <td><Field as="select" name="Travel_Drive_sensing_plate_home_position_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_sensing_plate_home_position_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Slowdown position</td>
            <td>Visual</td>
            <td><Field as="select" name="Travel_Drive_sensing_plate_Slowdown_position_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_sensing_plate_Slowdown_position_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Over-run limit position</td>
            <td>Visual</td>
            <td><Field as="select" name="Travel_Drive_sensing_plate_Over_run_limit_position_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_sensing_plate_Over_run_limit_position_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Visual</td>
            <td><Field as="select" name="Travel_Drive_Bay_centering_stop_position_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_Bay_centering_stop_position_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Measure</td>
            <td><Field as="select" name="Travel_Drive_Bay_centering_measurement_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_Bay_centering_measurement_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Wear & tear</td>
            <td>Visual</td>
            <td><Field as="select" name="Travel_Drive_Bay_Bottom_rail_Wear_tear_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_Bay_Bottom_rail_Wear_tear_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Visual</td>
            <td><Field as="select" name="Travel_Drive_Bay_Bottom_rail_Rail_joint_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_Bay_Bottom_rail_Rail_joint_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Retighten</td>
            <td><Field as="select" name="Travel_Drive_Bay_Bottom_rail_Shim_plate_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Travel_Drive_Bay_Bottom_rail_Shim_plate_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
        ...
        <table>
          ...
          <tr>
            ...
            <td>Rotating sound</td>
            <td>Sound</td>
            <td><Field as="select" name="Slide_Fork_Motor_sound_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Slide_Fork_Motor_sound_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Temperature</td>
            <td>Touch</td>
            <td><Field as="select" name="Slide_Fork_Motor_Temperature_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Slide_Fork_Motor_Temperature_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Lining gap</td>
            <td>Measure</td>
            <td><Field as="select" name="Slide_Fork_E_magnetic_brake_gap_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Slide_Fork_E_magnetic_brake_gap_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Lining wear & tear</td>
            <td>Visual</td>
            <td><Field as="select" name="Slide_Fork_E_magnetic_brake_wear_tear_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Slide_Fork_E_magnetic_brake_wear_tear_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Rotating sound</td>
            <td>Visual</td>
            <td><Field as="select" name="Slide_Fork_Cyclo_gear_sound_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Slide_Fork_Cyclo_gear_sound_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Grease amount</td>
            <td>Visual</td>
            <td><Field as="select" name="Slide_Fork_Cyclo_gear_Grease_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Slide_Fork_Cyclo_gear_Grease_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>Rotating sound</td>
            <td>Sound</td>
            <td><Field as="select" name="Slide_Fork_Rack_pinion_sound_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
          ...
          <td><Field as="select" name="Slide_Fork_Rack_pinion_sound_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Lubrication</td>
          <td>Visual</td>
          <td><Field as="select" name="Slide_Fork_Rack_pinion_Lubrication_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Slide_Fork_Rack_pinion_Lubrication_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Wear & tear</td>
          <td>Visual</td>
          <td><Field as="select" name="Slide_Fork_Rack_pinion_Wear_tear_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Slide_Fork_Rack_pinion_Wear_tear_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Backlash</td>
          <td>Measure</td>
          <td><Field as="select" name="Slide_Fork_Rack_pinion_Backlash_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Slide_Fork_Rack_pinion_Backlash_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Touch</td>
          <td><Field as="select" name="Slide_Fork_Torque_limiter_Locknut_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Slide_Fork_Torque_limiter_Locknut_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Visual</td>
          <td><Field as="select" name="Slide_Fork_Torque_limiter_Mechanic_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Slide_Fork_Torque_limiter_Mechanic_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Lubrication</td>
          <td>Visual</td>
          <td><Field as="select" name="Slide_Fork_Rack_gear_Lubrication_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Slide_Fork_Rack_gear_Lubrication_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Deformation</td>
          <td>Visual</td>
          <td><Field as="select" name="Slide_Fork_Rack_gear_Deformation_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Slide_Fork_Rack_gear_Deformation_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Wear & tear</td>
          <td>Visual</td>
          <td><Field as="select" name="Slide_Fork_Rack_gear_Wear_tear_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Slide_Fork_Rack_gear_Wear_tear_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Rotating sound</td>
          <td>Sound</td>
          <td><Field as="select" name="Slide_Fork_Sprocket_sound_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Slide_Fork_Sprocket_sound_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Wear & tear</td>
          <td>Visual</td>
          <td><Field as="select" name="Slide_Fork_Sprocket_Wear_tear_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Slide_Fork_Sprocket_Wear_tear_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Visual</td>
          <td><Field as="select" name="Slide_Fork_Stopping_sensing_Fork_centering_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Slide_Fork_Stopping_sensing_Fork_centering_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Fork stroke</td>
          <td>Visual</td>
          <td><Field as="select" name="Slide_Fork_Stopping_sensing_Fork_stroke_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Slide_Fork_Stopping_sensing_Fork_stroke_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Visual</td>
          <td><Field as="select" name="Fork_body_Middle_rail_Grove_wear_tear_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Fork_body_Middle_rail_Grove_wear_tear_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Lubrication</td>
          <td>Visual</td>
          <td><Field as="select" name="Fork_body_Middle_rail_Lubrication_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Fork_body_Middle_rail_Lubrication_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Wear & tear</td>
          <td>Visual</td>
          <td><Field as="select" name="Fork_body_Cam_followers_Wear_tear_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Fork_body_Cam_followers_Wear_tear_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Lubrication</td>
          <td>Visual</td>
          <td><Field as="select" name="Fork_body_Cam_followers_Lubrication_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Fork_body_Cam_followers_Lubrication_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
      ...
      <table>
        ...
        <tr>
          ...
          <td>Touch</td>
          <td><Field as="select" name="Trolley_Unit_Collector_arm_Fasteners_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Trolley_Unit_Collector_arm_Fasteners_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Wear & tear</td>
          <td>Visual</td>
          <td><Field as="select" name="Trolley_Unit_Collector_arm_Wear_tear_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Trolley_Unit_Collector_arm_Wear_tear_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Visual</td>
          <td><Field as="select" name="Trolley_Unit_Collector_arm_Dust_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Trolley_Unit_Collector_arm_Dust_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
      ...
      <table>
        ...
        <tr>
          ...
          <td>Touch</td>
          <td><Field as="select" name="Control_Panel_E_magnetic_contactors_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Control_Panel_E_magnetic_contactors_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Visual</td>
          <td><Field as="select" name="Control_Panel_Electric_wiring_Snapped_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Control_Panel_Electric_wiring_Snapped_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Visual</td>
          <td><Field as="select" name="Control_Panel_Electric_wiring_connection_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Control_Panel_Electric_wiring_connection_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Measure</td>
          <td><Field as="select" name="Control_Panel_Transformer_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Control_Panel_Transformer_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Visual</td>
          <td><Field as="select" name="Control_Panel_PC_Board_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Control_Panel_PC_Board_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Functionality</td>
          <td>Visual</td>
          <td><Field as="select" name="Control_Panel_panel_buttons_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Control_Panel_panel_buttons_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Functionality</td>
          <td>Visual</td>
          <td><Field as="select" name="Control_Panel_Indicator_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Control_Panel_Indicator_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Functionality</td>
          <td>Visual</td>
          <td><Field as="select" name="Control_Panel_E_stop_button_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Control_Panel_E_stop_button_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Functionality</td>
          <td>Visual</td>
          <td><Field as="select" name="Control_Panel_Ventilation_fan_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Control_Panel_Ventilation_fan_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Functionality</td>
          <td>Visual</td>
          <td><Field as="select" name="Control_Panel_4bit_sensor_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Control_Panel_4bit_sensor_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Alignment</td>
          <td>Visual</td>
          <td><Field as="select" name="Control_Panel_Optical_transmitter_Alignment_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Control_Panel_Optical_transmitter_Alignment_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
        ...
        <tr>
          ...
          <td>Visual</td>
          <td><Field as="select" name="Control_Panel_Optical_transmitter_LED_result" >
            <option value="" disabled selected>Select option</option>
            <option value="O">O</option>
            <option value="∆">∆</option>
            <option value="X">X</option>
          ...
          <td><Field as="select" name="Control_Panel_Optical_transmitter_LED_action" >
            <option value="" disabled selected>Select option</option>
            <option value="A">A</option>
            <option value="C">C</option>
            <option value="R">R</option>
      ...
      <table><tbody>
        ...
        <table>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Detectors_Pre_occupied_load_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Detectors_Pre_occupied_load_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Detectors_Load_profile_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Detectors_Load_profile_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Detectors_High_load_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Detectors_High_load_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Detectors_Fork_loaded_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Detectors_Fork_loaded_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Detectors_Carriage_chain_loose_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Detectors_Carriage_chain_loose_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Detectors_Load_overhanged_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Detectors_Load_overhanged_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Detectors_Load_projection_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Detectors_Load_projection_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Detectors_Fork_end_detectors_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Detectors_Fork_end_detectors_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Detectors_Fork_centering_detectors_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Detectors_Fork_centering_detectors_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Crane_travelling_Home_position_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Crane_travelling_Home_position_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Crane_travelling_Regular_position_front_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Crane_travelling_Regular_position_front_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Crane_travelling_Regular_position_rear_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Crane_travelling_Regular_position_rear_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Crane_travelling_Forward_decel1_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Crane_travelling_Forward_decel1_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Crane_travelling_Backward_decel1_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Crane_travelling_Backward_decel1_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Crane_travelling_Dec_1_2_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Crane_travelling_Dec_1_2_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Crane_travelling_End_limit_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Crane_travelling_End_limit_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Carriage_hoisting_Upper_level_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Carriage_hoisting_Upper_level_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Carriage_hoisting_Lower_level_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Carriage_hoisting_Lower_level_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Carriage_hoisting_Fork_level_zone_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Carriage_hoisting_Fork_level_zonel_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Carriage_hoisting_Station_upper_level_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Carriage_hoisting_Station_upper_level_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Carriage_hoisting_Station_lower_level_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Carriage_hoisting_Station_lower_level_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Carriage_hoisting_Station_Upward_decel1_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Carriage_hoisting_Station_Upward_decel1_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Carriage_hoisting_Station_Downward_decel1_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Carriage_hoisting_Station_Downward_decel1_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Carriage_hoisting_Decel2_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Carriage_hoisting_Decel2_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
          ...
          <tr>
            ...
            <td>I/O Check</td>
            <td>Touch</td>
            <td><Field as="select" name="Carriage_hoisting_End_limit_result" >
              <option value="" disabled selected>Select option</option>
              <option value="O">O</option>
              <option value="∆">∆</option>
              <option value="X">X</option>
            ...
            <td><Field as="select" name="Carriage_hoisting_End_limit_action" >
              <option value="" disabled selected>Select option</option>
              <option value="A">A</option>
              <option value="C">C</option>
              <option value="R">R</option>
