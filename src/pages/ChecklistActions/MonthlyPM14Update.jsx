...
function MonthlyPM14Update() {
    ...
    useEffect(() => {
        axios.get(`https://maintaimdb-044f7fcd2d92.herokuapp.com/crane14checklist/byId/${id}`).then((response) => {
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        axios.put(
            `https://maintaimdb-044f7fcd2d92.herokuapp.com/crane14checklist/update/byId/${id}`, initialValues).then(res => {
                console.log(res);
                navigate('/checklists')
